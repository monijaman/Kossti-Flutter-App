class AppStrings {
  ...
  static const String reviewBody = 'Review';
  static const String reviewSubmitted = 'Review submitted successfully';
  static const String noReviews = 'No reviews yet. Be the first to review!';
  ...
  static const String totalBrands = 'Total Brands';
  static const String pendingReviews = 'Pending Reviews';
  static const String approveReview = 'Approve';
  static const String rejectReview = 'Reject';
  ...
  static const String categoryNameBn = 'Category Name (Bengali)';
  static const String brandNameEn = 'Brand Name (English)';
  static const String brandNameBn = 'Brand Name (Bengali)';
  ...
  static const String sortPriceAsc = 'Price: Low to High';
  static const String sortPriceDesc = 'Price: High to Low';

  // Profile
  static const String signInPrompt = 'Sign in to your account';
  static const String signInBenefit =
      'Login to access your profile, write reviews and more';

  // Register
  static const String createAccount = 'Create Account';
  static const String createAccountSubtitle =
      'Join Kossti and start reviewing products';
